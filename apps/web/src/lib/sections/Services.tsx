            ...
            .map((service, index) => (
              ...
              >
                ...
                <div className="p-6">
                  {/* Title & Description */}
                  <div className="mb-6">
                    <h3 className="text-[17.5px] tracking-[0.4375px] text-gray-900 mb-1.5">{service.title}</h3>
                    <p className="text-[14px] leading-[22.75px] text-gray-600">{service.description}</p>
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="text-[21px] leading-7 tracking-[-0.525px] text-primary">
                      {typeof service.prices === 'object' ? JSON.stringify(service.prices) : service.prices}
                    </span>
                  </div>
